    ...
    public SecurityFilterChain securityFilterChain( HttpSecurity http) throws Exception {
        ...
        http
           ...
           .authorizeRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/tags/saveTag").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/tags/updateTag/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/tags/deletarTag/{id}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/userView/saveTag").hasRole("ADMIN")
